...
namespace OneAdvisor.Data
{
    public class SeedData
    {
        ...
        public static List<AdviceServiceEntity> GetAdviceServices()
        {
            ...
            list.Add(new AdviceServiceEntity() { Id = Guid.Parse("f8d0f35b-9eb5-4be4-b2ab-0a9c3547360d"), Name = "Full financial needs analysis" });
            list.Add(new AdviceServiceEntity() { Id = Guid.Parse("b2435736-8fa7-4b34-a7b8-ee08f949e863"), Name = "Risk Planning" });
            list.Add(new AdviceServiceEntity() { Id = Guid.Parse("04815a0f-6102-47db-8a5c-e28baa9cf428"), Name = "Planning for retirement" });
            list.Add(new AdviceServiceEntity() { Id = Guid.Parse("7f3eb0b1-5431-4501-a257-f6c76b96f17a"), Name = "Planning at retirement" });
            list.Add(new AdviceServiceEntity() { Id = Guid.Parse("e3751712-0324-4be4-b2dc-332890e72b0c"), Name = "Savings planning" });
            list.Add(new AdviceServiceEntity() { Id = Guid.Parse("68523839-e035-43e2-a8e3-f54eaa273750"), Name = "Investment planning" });
            list.Add(new AdviceServiceEntity() { Id = Guid.Parse("96dadc7a-7b5a-4fa0-bea8-8423335d7c45"), Name = "Employee Benefits" });
            list.Add(new AdviceServiceEntity() { Id = Guid.Parse("d016b488-c4f8-47ff-a833-626b476648d4"), Name = "Planning for Business Assurance" });
            list.Add(new AdviceServiceEntity() { Id = Guid.Parse("009c5cec-9b9e-451f-98a9-8335671dc480"), Name = "Planning for Medical Benefits" });
            list.Add(new AdviceServiceEntity() { Id = Guid.Parse("27da6f44-891c-46b5-a215-6120eef79ac3"), Name = "Funeral Benefits" });
            list.Add(new AdviceServiceEntity() { Id = Guid.Parse("dbc296a3-34d3-4102-a5c0-c84061d88c3d"), Name = "Wills" });
            list.Add(new AdviceServiceEntity() { Id = Guid.Parse("44cc8294-b725-4d34-9900-fe662365c475"), Name = "Medical Gap Cover" });
        ...
        public static List<LicenseCategoryEntity> GetLicenseCategories()
        {
            ...
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.1", Name = "Long-term Insurance subcategory A" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.2", Name = "Short-term Insurance Personal Lines" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.3", Name = "Long-term Insurance" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.3.1", Name = "Subcategory B1" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.3.2", Name = "Subcategory B2" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.4", Name = "Long-term Insurance subcategory C" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.5", Name = "Retail Pension Benefits" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.6", Name = "Short-term Insurance Commercial Lines" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.7", Name = "Pension Fund Benefits" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.8", Name = "Securities and instruments: Shares" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.9", Name = "Securities and Instruments: Money market instruments" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.10", Name = "Securities and Instruments: Debentures and securitised debt" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.11", Name = "Securities and Instruments: Warrants, certificates and other instruments acknowledging debt" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.12", Name = "Securities and Instruments: Bonds" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.13", Name = "Securities and Instruments: Derivative instruments excluding warrants" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.14", Name = "Participatory Interests in one or more collective Investments schemes" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.15", Name = "Forex Investment Business" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.16", Name = "Health Service Benefits" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.17", Name = "Long-term Deposits" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.18", Name = "Short-term Deposits" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "1.19", Name = "Friendly Society Benefits" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "2.1", Name = "Long-term Insurance" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "2.1.1", Name = "Subcategory B1" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "2.1.2", Name = "Subcategory B2" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "2.2", Name = "Long-term Insurance subcategory C" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "2.3", Name = "Retail Pension Benefits" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "2.4", Name = "Pension Fund Benefits" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "2.5", Name = "Securities and instruments: Shares" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "2.6", Name = "Securities and Instruments: Money market instruments" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "2.7", Name = "Securities and Instruments: Debentures and securitised debt" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "2.8", Name = "Securities and Instruments: Warrants, certificates and other instruments acknowledging debt" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "2.9", Name = "Securities and Instruments: Bonds" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "2.10", Name = "Securities and Instruments: Derivative instruments excluding warrants" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "2.11", Name = "Participatory Interests in one or more collective Investments schemes" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "2.12", Name = "Forex Investment Business" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "2.13", Name = "Long-term Deposits" });
            list.Add(new LicenseCategoryEntity() { Id = Guid.NewGuid(), Code = "2.14", Name = "Short-term Deposits" });
