...
namespace OneAdvisor.Data.Migrations
{
    ...
    [Migration("20200405133251_newDirectoryLookups")]
    partial class newDirectoryLookups
    {
            ...
            modelBuilder.Entity("OneAdvisor.Data.Entities.Directory.Lookup.LicenseCategoryEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d30bca0f-7f36-4bb2-aefa-c01c1e8ef411"),
                            Code = "1.1",
                            Name = "Long-term Insurance subcategory A"
                        },
                        new
                        {
                            Id = new Guid("11dd813b-9869-4ccf-a049-c8140d8652a5"),
                            Code = "1.2",
                            Name = "Short-term Insurance Personal Lines"
                        },
                        new
                        {
                            Id = new Guid("2529467c-5377-4068-8e80-04c2bb9e1ef9"),
                            Code = "1.3",
                            Name = "Long-term Insurance"
                        },
                        new
                        {
                            Id = new Guid("3d4da6d1-2091-49f6-9fc4-b82deb92a0fa"),
                            Code = "1.3.1",
                            Name = "Subcategory B1"
                        },
                        new
                        {
                            Id = new Guid("392b4516-c3c1-4ff1-ae1c-86f913336897"),
                            Code = "1.3.2",
                            Name = "Subcategory B2"
                        },
                        new
                        {
                            Id = new Guid("d119563b-958d-4f97-ba9c-e0b28e4a3c86"),
                            Code = "1.4",
                            Name = "Long-term Insurance subcategory C"
                        },
                        new
                        {
                            Id = new Guid("53e8b4c6-271f-4f30-af1e-55a9557539ad"),
                            Code = "1.5",
                            Name = "Retail Pension Benefits"
                        },
                        new
                        {
                            Id = new Guid("cc666ccc-5dbb-49fc-8c71-9780765f47d4"),
                            Code = "1.6",
                            Name = "Short-term Insurance Commercial Lines"
                        },
                        new
                        {
                            Id = new Guid("78d01ab4-b2d7-4803-a49a-f095eb6897b5"),
                            Code = "1.7",
                            Name = "Pension Fund Benefits"
                        },
                        new
                        {
                            Id = new Guid("49e79bc6-1ea0-42e8-8d7c-72109967d51e"),
                            Code = "1.8",
                            Name = "Securities and instruments: Shares"
                        },
                        new
                        {
                            Id = new Guid("d04c9714-bb11-4f6d-932a-7bdcde1c0f70"),
                            Code = "1.9",
                            Name = "Securities and Instruments: Money market instruments"
                        },
                        new
                        {
                            Id = new Guid("4eabb7cc-d69f-4e2b-8084-29c0f702dfe3"),
                            Code = "1.10",
                            Name = "Securities and Instruments: Debentures and securitised debt"
                        },
                        new
                        {
                            Id = new Guid("0dc7038b-69fb-4721-ac72-745b36412ce2"),
                            Code = "1.11",
                            Name = "Securities and Instruments: Warrants, certificates and other instruments acknowledging debt"
                        },
                        new
                        {
                            Id = new Guid("f0f97920-c0c0-47fc-805b-ac012c18489d"),
                            Code = "1.12",
                            Name = "Securities and Instruments: Bonds"
                        },
                        new
                        {
                            Id = new Guid("c78506dc-7fb7-42a2-9470-5244dd39e176"),
                            Code = "1.13",
                            Name = "Securities and Instruments: Derivative instruments excluding warrants"
                        },
                        new
                        {
                            Id = new Guid("f391548e-9397-4381-9e1f-0f5663b9d64f"),
                            Code = "1.14",
                            Name = "Participatory Interests in one or more collective Investments schemes"
                        },
                        new
                        {
                            Id = new Guid("1a0da339-324b-4df0-bfd5-141459b52603"),
                            Code = "1.15",
                            Name = "Forex Investment Business"
                        },
                        new
                        {
                            Id = new Guid("a5570af8-49df-44ac-abe8-4669f1c25458"),
                            Code = "1.16",
                            Name = "Health Service Benefits"
                        },
                        new
                        {
                            Id = new Guid("0dc75e74-e2a3-4ae9-b2fa-3d81df0e1a9e"),
                            Code = "1.17",
                            Name = "Long-term Deposits"
                        },
                        new
                        {
                            Id = new Guid("2f09b00f-2db2-40ec-990a-0092caeec303"),
                            Code = "1.18",
                            Name = "Short-term Deposits"
                        },
                        new
                        {
                            Id = new Guid("627bc981-dcc8-4c7e-8aae-d4fb8cab0f26"),
                            Code = "1.19",
                            Name = "Friendly Society Benefits"
                        },
                        new
                        {
                            Id = new Guid("9a6f6966-261c-4af5-87a9-1abf49d49032"),
                            Code = "2.1",
                            Name = "Long-term Insurance"
                        },
                        new
                        {
                            Id = new Guid("5166c9c8-3532-4c16-abad-c992736117c8"),
                            Code = "2.1.1",
                            Name = "Subcategory B1"
                        },
                        new
                        {
                            Id = new Guid("0721978d-ff2d-483d-a6a2-6dd90d665082"),
                            Code = "2.1.2",
                            Name = "Subcategory B2"
                        },
                        new
                        {
                            Id = new Guid("a2654558-db31-4760-a398-bb4e3232bb2e"),
                            Code = "2.2",
                            Name = "Long-term Insurance subcategory C"
                        },
                        new
                        {
                            Id = new Guid("b3001b48-7d25-4c47-a696-24ecebea5aa6"),
                            Code = "2.3",
                            Name = "Retail Pension Benefits"
                        },
                        new
                        {
                            Id = new Guid("6b828217-d41a-4859-92dd-f99d910dd2c3"),
                            Code = "2.4",
                            Name = "Pension Fund Benefits"
                        },
                        new
                        {
                            Id = new Guid("3c028460-cfb6-4cdb-be5e-5884a3ea2437"),
                            Code = "2.5",
                            Name = "Securities and instruments: Shares"
                        },
                        new
                        {
                            Id = new Guid("47427236-b3c8-4b8d-ab02-aa5bafe6b4df"),
                            Code = "2.6",
                            Name = "Securities and Instruments: Money market instruments"
                        },
                        new
                        {
                            Id = new Guid("1c5579f2-4aae-4955-bc9c-afb23b8915a3"),
                            Code = "2.7",
                            Name = "Securities and Instruments: Debentures and securitised debt"
                        },
                        new
                        {
                            Id = new Guid("3b4c350f-4ed0-4232-a920-b890a17ac929"),
                            Code = "2.8",
                            Name = "Securities and Instruments: Warrants, certificates and other instruments acknowledging debt"
                        },
                        new
                        {
                            Id = new Guid("a8bb6484-fe26-49ed-bbb5-06f58e7918cd"),
                            Code = "2.9",
                            Name = "Securities and Instruments: Bonds"
                        },
                        new
                        {
                            Id = new Guid("ce0f9141-d378-4cbe-8ca7-4ce32f87865c"),
                            Code = "2.10",
                            Name = "Securities and Instruments: Derivative instruments excluding warrants"
                        },
                        new
                        {
                            Id = new Guid("b3425646-8ccc-465d-a24e-dcbde9b2c17f"),
                            Code = "2.11",
                            Name = "Participatory Interests in one or more collective Investments schemes"
                        },
                        new
                        {
                            Id = new Guid("f914dfb2-5897-410f-8bde-07ff1a30097f"),
                            Code = "2.12",
                            Name = "Forex Investment Business"
                        },
                        new
                        {
                            Id = new Guid("9bd68901-0ebc-4d43-b3f6-47c540e2b80c"),
                            Code = "2.13",
                            Name = "Long-term Deposits"
                        },
                        new
                        {
                            Id = new Guid("e998959e-041d-4395-858f-8816f88f7999"),
                            Code = "2.14",
                            Name = "Short-term Deposits"
                        });
                });
