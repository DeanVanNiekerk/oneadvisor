...
namespace OneAdvisor.Data.Migrations
{
    ...
    [Migration("20200518073217_newEarningsType")]
    partial class newEarningsType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OneAdvisor.Data.Entities.Client.Lookup.PolicyProductTypeEntity", b =>
                {
                    ...
                    b.Property<string>("_PolicyTypeCharacteristics")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("OneAdvisor.Data.Entities.Client.Lookup.PolicyTypeCharacteristicEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("clt_PolicyTypeCharacteristic");
                });
            ...
            modelBuilder.Entity("OneAdvisor.Data.Entities.Commission.CommissionStatementTemplateEntity", b =>
                {
                    ...
                    b.Property<bool>("BrokerSpecific")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("OneAdvisor.Data.Entities.Commission.Lookup.CommissionEarningsTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("1255d2c7-e637-6331-0114-2abb8a24722e"),
                            DisplayOrder = 4,
                            Name = "Quarterly Annuity"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("OneAdvisor.Data.Entities.Directory.UseCaseEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "cmp_view_roa_invest",
                            ApplicationId = new Guid("ef1bb77d-981a-743f-9543-ec36f396536c"),
                            Name = "View ROA Invest Document"
                        });
                });
            ...
            modelBuilder.Entity("OneAdvisor.Data.Entities.Client.Lookup.PolicyTypeCharacteristicEntity", b =>
                {
                    b.HasOne("OneAdvisor.Data.Entities.Client.Lookup.PolicyTypeEntity", "PolicyType")
                        .WithMany("PolicyTypeCharacteristics")
                        .HasForeignKey("PolicyTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
