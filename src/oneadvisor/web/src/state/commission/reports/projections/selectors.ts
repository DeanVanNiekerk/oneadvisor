...
import { CommissionEarningsTypeListState } from "../../lookups/commissionEarningsTypes";
import { ProjectionsState } from "./types";

const rootSelector = (state: RootState): ProjectionsState => state.commission.reports.projections;

export const commissionProjectionsSelector: (state: RootState) => ProjectionsState = createSelector(
    rootSelector,
    (root) => root
);
