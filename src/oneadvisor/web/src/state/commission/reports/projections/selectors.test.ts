...
import { PolicyTypeListState } from "@/state/lookups/client";
...
describe("report commission projects selectors", () => {
    describe("projectionGroupTableRowsSelector", () => {
        ...
        const commissionEarningsTypeState: CommissionEarningsTypeListState = {
            items: [
                {
        ...
        const companiesState: CompanyListState = {
            fetching: false,
            items: [
                {
                    id: companyId1,
