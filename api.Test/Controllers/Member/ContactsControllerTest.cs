...
using api.Controllers.Member.Contacts;
...
namespace api.Test.Controllers.Member
{
    public class ContactsControllerTest
    {
        ...
        public void ContactModelComposition()
        {
            ...
            Assert.True(typeof(Contact).HasProperty("MemberId"));
        ...
        public async Task Index()
        {
            ...
            var result = await controller.Index($"memberId={contact.MemberId}");
            ...
            Assert.Equal(contact.MemberId, queryOptions.MemberId);
