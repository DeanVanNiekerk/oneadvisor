    ...
    this.props.dispatch(
      getCommissionErrors(this.props.statement.id, true, errors => {
        ...
        downloadExcel(
          ...
          `MappingErrors_${this.getCompanyName()}_${moment(this.props.statement.date).format(DATE_FORMAT)}.xlsx`
        );
      })
    );
  };
        ...
        <PreviewCardContainer>
          ...
          >
            {statement && (
              <>
                ...
                <PreviewCardRow label="Amount (incl VAT)" value={<Currency amount={statement.amountIncludingVAT} />} />
          ...
          {statement && statement.formatErrorCount > 0 && (
            <PreviewCard
              ...
              height={cardHeight}
            >
              {statement && <StatementPreviewErrorCount count={statement.formatErrorCount} errorType="format" />}
            </PreviewCard>
          )}
          {statement && statement.mappingErrorCount > 0 && (
            <PreviewCard
              ...
              height={cardHeight}
            >
              {statement && <StatementPreviewErrorCount count={statement.mappingErrorCount} errorType="mapping" />}
            </PreviewCard>
          )}
        </PreviewCardContainer>
