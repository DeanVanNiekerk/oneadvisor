...
class CommissionTypesForm extends Component<Props, State> {
    ...
    syncCommissionTypes = (values: string[]) => {
        const existingValues = this.state.commissionTypes.types.map(t => t.value.toLowerCase());
            ...
            <>
                ...
                <Form>
                    ...
                    <FormInput
                        ...
                        validationResults={validationResults}
                        addonAfter={
                            <Popover title="Format" content={this.mappingInfo()} placement="left">
                ...
                {this.props.commissionStatementTemplateId && (
                    <Upload
                        ...
                        action={`${statementTemplatesApi}/${this.props.commissionStatementTemplateId}/${this.props.selectedSheet.position}/excel/uniqueCommissionTypes`}
                        headers={{
                        ...
                        <List.Item key={index} actions={[this.getActions(type, index)]}>
                            <Form layout="inline">
                                <FormInput
                                    ...
                                    value={type.value}
                                    onChange={(fieldName: string, value: string) => {
                                        this.onTypesChange(fieldName, value, index);
                                    }}
                                    validationResults={validationResults}
                                    width="320px"
                                />
