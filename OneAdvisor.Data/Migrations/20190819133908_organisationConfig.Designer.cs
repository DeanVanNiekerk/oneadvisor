...
namespace OneAdvisor.Data.Migrations
{
    ...
    [Migration("20190819133908_organisationConfig")]
    partial class organisationConfig
    {
            ...
            modelBuilder.Entity("OneAdvisor.Data.Entities.Commission.CommissionEntity", b =>
                {
                    ...
                    b.HasIndex("UserId", "CommissionStatementId")
                        .HasName("INDEX_Commission_UserId_CommissionStatementId")
                        .HasAnnotation("SqlServer:IncludeIndex", "[AmountIncludingVAT], [CommissionTypeId], [PolicyId], [VAT]");
            ...
            modelBuilder.Entity("OneAdvisor.Data.Entities.Directory.UseCaseEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "dir_edit_change_logs",
                            ApplicationId = new Guid("66c3b4e8-8a30-4a4b-be4d-3928d12fefe9"),
                            Name = "Edit Change Logs"
                        },
                        new
                        {
                            Id = "dir_view_lookups",
