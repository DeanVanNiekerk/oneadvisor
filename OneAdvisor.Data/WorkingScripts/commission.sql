...
CREATE NONCLUSTERED INDEX [MemberOrganisationId] ON [dbo].[mem_Member] ([CommissionStatementId]) INCLUDE ([AmountIncludingVAT], [CommissionTypeId], [PolicyId], [VAT]) WITH (ONLINE = ON)
