...
describe("reports: member revenue: list actions", () => {
    it("should dispatch API when fetchCommissions is called", () => {
        ...
        const api = `${commissionReportsApi}/memberRevenueData?pageNumber=${
            pageOptions.number
        }&pageSize=${
            pageOptions.size
        ...
        expect(
            actions.fetchMemberRevenueData(pageOptions, sortOptions, filters)
