...
namespace OneAdvisor.Service.Test.Commission
{
    ...
    public class ImportCommissionServiceTest
    {
        ...
        public async Task ImportCommission_BadFormat_InsertError()
        {
            ...
            var statement = TestHelper.InsertDefaultCommissionStatement(options);
        ...
        [TestMethod]
        public async Task ImportCommission_SetCommisionType()
        {
            ...
            using (var context = new DataContext(options))
            {
                ...
                var service = new CommissionImportService(context, null, policyService, lookupService);
        ...
        [TestMethod]
        public async Task ImportCommission_SetPolicyAndMember()
        {
